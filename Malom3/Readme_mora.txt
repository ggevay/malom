...
This is the database of the ultra-strong solution of the Morabaraba
...
The game-theoretic value of Morabaraba is win for the first player.
This means that the program will always win when playing white, and
you have a chance to win, when you play white.
