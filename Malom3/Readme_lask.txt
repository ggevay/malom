...
This is the database of the ultra-strong solution of the Lasker
...
The game-theoretic value of standard Lasker is draw. This means that
the program will always achieve at least a draw, and if you make
mistakes, then it may win. But our ultra-strong solution shows that
white has an advantage (with regard to distinguishing between draws
with our algorithm), so you will have a very hard time when playing
black.
